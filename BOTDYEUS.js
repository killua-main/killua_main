...
function onBot({ models }) {
    ...
    login(loginData, async(loginError, loginApiData) => {
        ...
        const listener = require('./data/listen')(listenerData);
...
(async () => {
    try {
        ...
        authentication.sequelize = sequelize;
        const models = require('./data/database/model')(authentication);
...
console.log(color('[ CLIENT ] ➜', 'cyan'), color('BOT DYEUS successfully activated!! ', 'yellow'));